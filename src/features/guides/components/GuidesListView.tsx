                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: "16px", alignItems: "center", marginBottom: "16px" }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: "12px", color: "var(--color-text-muted)", marginTop: "2px", display: "flex", alignItems: "center", gap: "4px" }}>
                        <MapPinIcon size={12} color="var(--color-saudi-green)" />
                        <span>{isAr ? guide.cityAr : guide.cityEn}</span>
                      </span>
                    </div>
                  </div>
                  ...
                  {/* Meta stats */}
                  <div style={{ fontSize: "12px", color: "var(--color-text-secondary)", display: "flex", flexDirection: "column", gap: "4px", padding: "12px", background: "var(--color-bg-secondary)", borderRadius: "12px", border: "1px solid var(--color-border)" }}>
                    <div>{isAr ? "اللغات المتاحة:" : "Languages:"} {(isAr ? guide.languagesAr : guide.languagesEn).join(" • ")}</div>
                    <div>{isAr ? "أسطول المركبة:" : "Vehicle Fleet:"} {isAr ? guide.vehicleAr : guide.vehicleEn}</div>
                    <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                      <StarIcon size={13} color="#F59E0B" />
                      <span>{isAr ? "التقييم:" : "Rating:"}</span>
                      <strong style={{ color: "#F59E0B" }}>{guide.rating}</strong>
                      <span style={{ color: "var(--color-text-muted)" }}>({guide.tripsCompleted} {isAr ? "رحلة مكتملة" : "trips"})</span>
                    </div>
                  </div>
                </div>
